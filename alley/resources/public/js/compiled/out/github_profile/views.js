...
goog.provide('github_profile.views');
goog.require('cljs.core');
goog.require('re_frame.core');
goog.require('reagent.core');
github_profile.views.loading_throbber = (function github_profile$views$loading_throbber(){
...
github_profile.views.rolls_input = (function github_profile$views$rolls_input(){
var loading_QMARK_ = re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"loading?","loading?",1905707049)], null));
...
return cljs.core.reset_BANG_.call(null,rolls,p1__28098_SHARP_.target.value);
...
return on_click.call(null,p1__28099_SHARP_);
}
});})(loading_QMARK_,error_QMARK_,rolls,on_click))
...
github_profile.views.rolls = (function github_profile$views$rolls(){
return (function (){
...
github_profile.views.score = (function github_profile$views$score(){
return (function (){
...
github_profile.views.home_panel = (function github_profile$views$home_panel(){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.topbar","div.topbar",1355117265),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.container","div.container",72419955),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-lg-6.col-lg-offset-3","div.col-lg-6.col-lg-offset-3",-1015130696),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [github_profile.views.rolls_input], null)], null)], null)], null)], null)], null);
});
});
github_profile.views.profile_panel = (function github_profile$views$profile_panel(){
return (function (){
...
if(typeof github_profile.views.panels !== 'undefined'){
} else {
github_profile.views.panels = (function (){var method_table__17271__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"github-profile.views","panels"),cljs.core.identity,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__17275__auto__,method_table__17271__auto__,prefer_table__17272__auto__,method_cache__17273__auto__,cached_hierarchy__17274__auto__));
})();
}
cljs.core._add_method.call(null,github_profile.views.panels,new cljs.core.Keyword(null,"home-panel","home-panel",1226198754),(function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [github_profile.views.home_panel], null);
}));
cljs.core._add_method.call(null,github_profile.views.panels,new cljs.core.Keyword(null,"profile-panel","profile-panel",1578205687),(function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [github_profile.views.profile_panel], null);
}));
cljs.core._add_method.call(null,github_profile.views.panels,new cljs.core.Keyword(null,"default","default",-1987822328),(function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
}));
github_profile.views.main_panel = (function github_profile$views$main_panel(){
...
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [github_profile.views.loading_throbber], null),github_profile.views.panels.call(null,cljs.core.deref.call(null,active_panel)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [github_profile.views.rolls], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [github_profile.views.score], null)], null)], null);
});
;})(active_panel))
});

//# sourceMappingURL=views.js.map?rel=1521785049853